...
SYSTEM_PROMPT = "You must answer everything in Lithuanian. You must answer in 1-3 sentences. You are a tourism expert of Lithuania. You must answer politely."
ON_TOPIC_KEYWORDS = ["anyksc", "turiz", "touris", "reng", "viet"]
...
print("Hello. I am GEMINI. Please ask me questions related to tourism in Lithuania.")
